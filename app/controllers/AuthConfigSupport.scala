...
trait AuthConfigSupport extends AuthConfig {
  ...
  // ユーザーを表す型(= Userと指定するとAuthConfigSupport#Userと型がかぶるので、必ずmodels.Userと指定する)
  ...
  // IDからユーザーを解決する
  override def resolveUser(id: String)(implicit context: ExecutionContext): Future[Option[User]] = Future {
